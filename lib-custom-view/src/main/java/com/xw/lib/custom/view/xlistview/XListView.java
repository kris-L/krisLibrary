package com.xw.lib.custom.view.xlistview;
...
public class XListView extends ListView implements OnScrollListener {
    ...
    private void initWithContext(Context context) {
        ...
        sp = context.getSharedPreferences("soft", Context.MODE_PRIVATE);
        editor = sp.edit();
        // 初始化头部View
    ...
    private String refreshUpdatedAtValue() {
        lastUpdateTime = sp.getLong("lastTime", System.currentTimeMillis());
