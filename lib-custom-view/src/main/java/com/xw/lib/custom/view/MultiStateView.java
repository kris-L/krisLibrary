...
public class MultiStateView extends FrameLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        mContentViewID = a.getResourceId(R.styleable.MultiStateView_msv_contentViewId, -1);
    ...
    private void setContentView(View view) {
        if (mContentViewID > -1) {
            View childView = view.findViewById(mContentViewID);
            if (childView != null) {
                view = childView;
            }
        }
        if (isValidContentView(view)) mContentView = view;
    }

    /**
     * Returns the {@link View} associated with the {@link com.xw.lib.custom.view.MultiStateView.ViewState}
     *
     * @param state The {@link com.xw.lib.custom.view.MultiStateView.ViewState} with to return the view for
     * @return The {@link View} associated with the {@link com.xw.lib.custom.view.MultiStateView.ViewState}, null if no view is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link com.xw.lib.custom.view.MultiStateView.ViewState}
     *
     * @return
     */
    @ViewState
    ...
    /**
     * Sets the current {@link com.xw.lib.custom.view.MultiStateView.ViewState}
     *
     * @param state The {@link com.xw.lib.custom.view.MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link com.xw.lib.custom.view.MultiStateView.ViewState}
     */
     ...
     * @param state         The {@link com.xw.lib.custom.view.MultiStateView.ViewState}to set
     * @param switchToState If the {@link com.xw.lib.custom.view.MultiStateView.ViewState} should be switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link com.xw.lib.custom.view.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link com.xw.lib.custom.view.MultiStateView.ViewState} to set
     */
